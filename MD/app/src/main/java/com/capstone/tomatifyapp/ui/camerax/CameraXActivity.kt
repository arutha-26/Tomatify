package com.capstone.tomatifyapp.ui.camerax
...
import com.capstone.tomatifyapp.databinding.ActivityCameraXactivityBinding
import com.capstone.tomatifyapp.ui.predict.PredictActivity.Companion.CAMERA_X_RESULT
import com.capstone.tomatifyapp.utils.CAMERA_X_FILE
import com.capstone.tomatifyapp.utils.IS_CAMERA_BACK
import com.capstone.tomatifyapp.utils.createFile
import com.capstone.tomatifyapp.utils.rotateFile
    ...
    private fun takePhoto() {
        ...
        imageCapture.takePicture(outputOption, ContextCompat.getMainExecutor(this), object : ImageCapture.OnImageSavedCallback {
            ...
            override fun onError(exception: ImageCaptureException) {
                ...
                Toast.makeText(this@CameraXActivity, getString(R.string.failed_to_take_picture), Toast.LENGTH_SHORT).show()
            }

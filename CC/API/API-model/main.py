...
class_description = ['Penyakit ini disebabkan oleh empat spesies Xanthomonas. Gejala bacterial spot dimulai sebagai lesi kecil berwarna kuning kehijauan pada daun muda atau lesi gelap, basah kuyup, tampak berminyak pada daun yang lebih tua yang berubah menjadi cokelat hingga merah kecoklatan.',
                    ...
                    'Gejala khas tanaman yang terinfeksi penyakit dengan infeksi Yellow leaf curl adalah tanaman menjadi kerdil, klorosis daun melengkung ke atas, pengurangan ukuran daun dan penurunan produksi tomat. Penyakit ini ditularkan antar tanaman oleh serangga, Besimia tabaci (umumnya dikenal sebagai kutu kebul)']
